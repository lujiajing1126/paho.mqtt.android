...
public class MqttAndroidClient extends BroadcastReceiver implements
    ...
    private final class MyServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            // set ping sender class at once
            mqttService.setPingSender(MqttAndroidClient.this.clazz);
            bindedService = true;
    ...
    private final Class<? extends MqttPingSender> clazz;
    ...
    public MqttAndroidClient(Context context, String serverURI,
                             String clientId, Class<? extends MqttPingSender> clazz) {
        this(context, serverURI, clientId, null, Ack.AUTO_ACK, clazz);
    }
    ...
    public MqttAndroidClient(Context context, String serverURI,
                             String clientId) {
        this(context, serverURI, clientId, null, Ack.AUTO_ACK, AlarmPingSender.class);
    }
    ...
    public MqttAndroidClient(Context ctx, String serverURI, String clientId, Ack ackType) {
        this(ctx, serverURI, clientId, null, ackType, AlarmPingSender.class);
    }
    ...
    public MqttAndroidClient(Context ctx, String serverURI, String clientId, MqttClientPersistence persistence) {
        this(ctx, serverURI, clientId, persistence, Ack.AUTO_ACK, AlarmPingSender.class);
    }
     ...
     */
    public MqttAndroidClient(Context context, String serverURI,
                             String clientId, MqttClientPersistence persistence, Ack ackType, Class<? extends MqttPingSender> clazz) {
        myContext = context;
