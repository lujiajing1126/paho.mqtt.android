...
public class MqttService extends Service implements MqttTraceHandler {
    ...
    private Class<? extends MqttPingSender> pingSenderClazz = AlarmPingSender.class;
    ...
    public void setPingSender(Class<? extends MqttPingSender> pingSender) {
        this.pingSenderClazz = pingSender;
    }

    public Class<? extends MqttPingSender> getPingSender() {
        return this.pingSenderClazz;
    }
